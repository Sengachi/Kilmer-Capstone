...
Using $\Lambda$CDM cosmology's values of $\Omega_M$~=~0.3 and $\Omega_{\Lambda}$~=~0.7 this allows us to describe Equation \ref{eq:redshift} in detail. 
...
{\scriptsize
\beq
CDF(z) = \int_{0}^{z}\frac{0.149674~(1+z)^{2.37}}{\sqrt{0.7+0.3(1+z)^3}(1+\frac{(1+z)^{5.6}}{2.9})}
\label{eq:CDF}
\eeq}
